...
export const getMessagesAll = async (chatId) => {
  try {
    const response = await fetchRequest.get(`${API_URL}/api/chats/${chatId}/messages`)
    return response.data;
  } catch (error) {
...
export const getUsersAll = async (chatId) => {
  try {
    const response = await fetchRequest.get(`${API_URL}/api/chats/${chatId}/users`)
...
export const getUserChats = async () => {
  try {
    const response = await fetchRequest.get(`${API_URL}/api/chats`)
