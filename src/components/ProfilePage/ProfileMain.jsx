...
import { updateUserDataField,getUserData } from '../../service/apiService';
...
const handleChange = async (e, field, value, setValue) => {
    e.preventDefault();
    try {
    ...
    const changePassword = (e) =>{ 
        if(!passwordError && password) handleChange(e, 'password', password, setPassword);
    ...
    const changeUserName = (e) => {
        if(!usernameError && username) handleChange(e, 'username', username, setUserName);
    }
                ...
                <aside className="left-side-profile-block">
                    ...
                    <div className="rename">
                        <input
                            ...
                            placeholder='Name' className='inputText' type='text'/>
                        <Button className='name-button' onClick={(e)=>changeUserName(e)} >
                            <img src={RenameIcon} alt="Rename Icon" className='rename-btn' />
                        </Button>                        
                    </div>
                    {usernameValid && usernameError && <div className="error__color" >{usernameError}</div>}
                </aside>
                    ...
                    <div className="form-block">
                        ...
                        <form className='change-profile-form'>
                            ...
                            <input
                             ...
                             <Button onClick={(e)=>changeEmail(e)} className='apply-button'>Apply</Button>
                            {emailValid && emailError && <div className="error__color" >{emailError}</div>}
                    ...
                    <div className="form-block">
                        ...
                        <form className='change-profile-form'>
                            ...
                            <input
                                ...
                                required
                                />
                                <Button onClick={(e)=>changePassword(e)}  className='apply-button'>Apply</Button>
                                {passwordValid && passwordError && <div className="error__color" >{passwordError}</div>}
